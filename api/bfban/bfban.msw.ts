...
export const getGetBfBansCheckBfbanCheckbanGetMockHandler = () => {
  return http.get('*/bfban/checkban/', async () => {
    await delay(1000);
...
export const getBfBansCheckBfbanCheckbanPostMockHandler = () => {
  return http.post('*/bfban/checkban/', async () => {
    await delay(1000);
    return new HttpResponse(null,
      {
        status: 200,
...
export const getGetAllBannedPlayersBfbanBannedPlayersGetMockHandler = () => {
  return http.get('*/bfban/banned_players/', async () => {
    await delay(1000);
    return new HttpResponse(null,
      {
        status: 200,
...
export const getBfbanMock = () => [
  getGetBfBansCheckBfbanCheckbanGetMockHandler(),
  getBfBansCheckBfbanCheckbanPostMockHandler(),
  getGetAllBannedPlayersBfbanBannedPlayersGetMockHandler()
]
