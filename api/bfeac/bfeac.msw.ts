...
export const getGetAllBannedPlayersBfeacBannedPlayersGetMockHandler = () => {
  return http.get('*/bfeac/banned_players', async () => {
    await delay(1000);
...
export const getBfeacMock = () => [
  getGetAllBannedPlayersBfeacBannedPlayersGetMockHandler()
]
