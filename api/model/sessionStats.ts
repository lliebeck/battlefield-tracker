 ...
 */
import type { SessionGamemodeStats } from './sessionGamemodeStats';
import type { SessionKitStats } from './sessionKitStats';

export interface SessionStats {
  deaths: number;
  gamemodes: SessionGamemodeStats[];
  kills: number;
  kits: SessionKitStats[];
  losses: number;
  score: number;
  timePlayed: number;
  wins: number;
