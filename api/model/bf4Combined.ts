 ...
 */
import type { Bf4CombinedAvatar } from './bf4CombinedAvatar';
import type { BattlelogClassInfo } from './battlelogClassInfo';
import type { GamemodeInfo } from './gamemodeInfo';
import type { BattlelogPlatoonInfo } from './battlelogPlatoonInfo';
import type { ProgressInfo } from './progressInfo';
import type { Bf4CombinedUserId } from './bf4CombinedUserId';
import type { Bf4CombinedUserName } from './bf4CombinedUserName';
import type { BattlelogVehicleStats } from './battlelogVehicleStats';
import type { BattlelogWeaponStats } from './battlelogWeaponStats';

export interface Bf4Combined {
  accuracy: number;
  avatar?: Bf4CombinedAvatar;
  avengerKills: number;
  bestClass: number;
  classes: BattlelogClassInfo[];
  ...
  userId?: Bf4CombinedUserId;
  userName?: Bf4CombinedUserName;
  vehicles: BattlelogVehicleStats[];
  weapons: BattlelogWeaponStats[];
  winPercent: number;
  wins: number;
}
