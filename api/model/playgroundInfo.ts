 ...
 */
import type { PlaygroundInfoErrors } from './playgroundInfoErrors';
import type { PlaygroundInfoOriginalPlayground } from './playgroundInfoOriginalPlayground';
import type { PlaygroundInfoProgressionMode } from './playgroundInfoProgressionMode';
import type { PlaygroundInfoTag } from './playgroundInfoTag';
import type { PlaygroundInfoValidatedPlayground } from './playgroundInfoValidatedPlayground';

export interface PlaygroundInfo {
  errors?: PlaygroundInfoErrors;
  originalPlayground?: PlaygroundInfoOriginalPlayground;
  progressionMode?: PlaygroundInfoProgressionMode;
  tag?: PlaygroundInfoTag;
  validatedPlayground?: PlaygroundInfoValidatedPlayground;
}
