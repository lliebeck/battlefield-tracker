 ...
 */
import type { KingstonPlatforms } from './kingstonPlatforms';

export type Bf2042statsBf2042StatsGetParams = {
/**
 * If it needs to return the raw stats
 */
raw?: boolean;
/**
 * If precentage values have to be returned as string, example: '50%' (enabled by default for backwards compatability)
 */
format_values?: boolean;
/**
 * Name of the player to get stats for
 */
name?: string | null;
/**
 * ID of the player to get stats for
 */
playerid?: number | null;
/**
 * Platform specific id of the player (oid)
 */
nucleus_id?: number | null;
/**
 * Platform the player uses (both ps4, ps5 and xboxone and xboxseries are as if they are the same platform for stats)
 */
platform?: KingstonPlatforms;
/**
 * If it needs to skip the battlelog player search
 */
skip_battlelog?: boolean;
};
