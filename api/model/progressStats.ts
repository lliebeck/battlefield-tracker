 ...
 */
import type { ProgressStatsAvatar } from './progressStatsAvatar';
import type { ProgressInfo } from './progressInfo';
import type { ProgressStatsUserId } from './progressStatsUserId';
import type { ProgressStatsUserName } from './progressStatsUserName';

export interface ProgressStats {
  avatar?: ProgressStatsAvatar;
  id: number;
  progress: ProgressInfo[];
  userId?: ProgressStatsUserId;
  userName?: ProgressStatsUserName;
}
