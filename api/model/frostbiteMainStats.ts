 ...
 */
import type { FrostbiteMainStatsAvatar } from './frostbiteMainStatsAvatar';
import type { FrostbiteMainStatsUserId } from './frostbiteMainStatsUserId';
import type { FrostbiteMainStatsUserName } from './frostbiteMainStatsUserName';

export interface FrostbiteMainStats {
  accuracy: number;
