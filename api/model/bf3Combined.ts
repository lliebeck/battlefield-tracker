 ...
 */
import type { Bf3CombinedAvatar } from './bf3CombinedAvatar';
import type { BattlelogClassInfo } from './battlelogClassInfo';
import type { Bf3CombinedUserId } from './bf3CombinedUserId';
import type { Bf3CombinedUserName } from './bf3CombinedUserName';
import type { BattlelogVehicleStats } from './battlelogVehicleStats';
import type { BattlelogWeaponStats } from './battlelogWeaponStats';

export interface Bf3Combined {
  accuracy: number;
  avatar?: Bf3CombinedAvatar;
  avengerKills: number;
  bestClass: number;
  ...
  userId?: Bf3CombinedUserId;
  userName?: Bf3CombinedUserName;
