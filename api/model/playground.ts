...
import type { PlaygroundBlocklyData } from './playgroundBlocklyData';
import type { Creation } from './creation';
import type { MapRotation } from './mapRotation';
import type { OriginalModRules } from './originalModRules';
import type { PlaygroundMutator } from './playgroundMutator';
import type { PlayerInfoReturn } from './playerInfoReturn';
import type { Restrictions } from './restrictions';
import type { PlaygroundSettings } from './playgroundSettings';

export interface Playground {
  assetCategories: AssetCategory[];
  blocklyData?: PlaygroundBlocklyData;
