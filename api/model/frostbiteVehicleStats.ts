 ...
 */
import type { FrostbiteVehicleStatsAvatar } from './frostbiteVehicleStatsAvatar';
import type { FrostbiteVehicleStatsUserId } from './frostbiteVehicleStatsUserId';
import type { FrostbiteVehicleStatsUserName } from './frostbiteVehicleStatsUserName';
import type { FrostbiteVehicleInfo } from './frostbiteVehicleInfo';

export interface FrostbiteVehicleStats {
  avatar?: FrostbiteVehicleStatsAvatar;
  id: number;
  userId?: FrostbiteVehicleStatsUserId;
  userName?: FrostbiteVehicleStatsUserName;
