 ...
 */
import type { BfvMainStatsAvatar } from './bfvMainStatsAvatar';
import type { BfvMainStatsUserId } from './bfvMainStatsUserId';
import type { BfvMainStatsUserName } from './bfvMainStatsUserName';

export interface BfvMainStats {
  accuracy: number;
  avatar?: BfvMainStatsAvatar;
  avengerKills: number;
  awardScore: number;
  bestClass: number;
  bonusScore: number;
  ...
  userId?: BfvMainStatsUserId;
  userName?: BfvMainStatsUserName;
  winPercent: number;
  wins: number;
}
