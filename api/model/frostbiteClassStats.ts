 ...
 */
import type { FrostbiteClassStatsAvatar } from './frostbiteClassStatsAvatar';
import type { FrostbiteClassInfo } from './frostbiteClassInfo';
import type { FrostbiteClassStatsUserId } from './frostbiteClassStatsUserId';
import type { FrostbiteClassStatsUserName } from './frostbiteClassStatsUserName';

export interface FrostbiteClassStats {
  avatar?: FrostbiteClassStatsAvatar;
  classes: FrostbiteClassInfo[];
  id: number;
  userId?: FrostbiteClassStatsUserId;
  userName?: FrostbiteClassStatsUserName;
}
