 ...
 */
import type { SubMenuTranslationItem } from './subMenuTranslationItem';
import type { CollectionSlot } from './collectionSlot';

export interface SubMenuItem {
  assets: SubMenuTranslationItem;
  gamemode: string;
  mixInfo: CollectionSlot;
}
