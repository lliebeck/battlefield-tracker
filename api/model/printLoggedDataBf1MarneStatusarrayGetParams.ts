 ...
 */
import type { FrostbiteRegionsWithMultiple } from './frostbiteRegionsWithMultiple';
import type { FrostbitePlatforms } from './frostbitePlatforms';
import type { StatusArrayType } from './statusArrayType';

export type PrintLoggedDataBf1MarneStatusarrayGetParams = {
/**
 * Number of days to get historic values for
 */
days?: number;
/**
 * Region to get historic values for
 */
region?: FrostbiteRegionsWithMultiple;
/**
 * Platform to get historic values for
 */
platform?: FrostbitePlatforms;
/**
 * Type of historic data to return
 */
type?: StatusArrayType;
};
