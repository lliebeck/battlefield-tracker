 ...
 */
import type { PlaygroundMutatorKindBoolSparse } from './playgroundMutatorKindBoolSparse';
import type { PlaygroundMutatorKindBoolValue } from './playgroundMutatorKindBoolValue';
import type { PlaygroundMutatorKindFloatSparse } from './playgroundMutatorKindFloatSparse';
import type { PlaygroundMutatorKindFloatValue } from './playgroundMutatorKindFloatValue';
import type { PlaygroundMutatorKindIntSparse } from './playgroundMutatorKindIntSparse';
import type { PlaygroundMutatorKindIntValue } from './playgroundMutatorKindIntValue';
import type { PlaygroundMutatorKindStringValue } from './playgroundMutatorKindStringValue';

export interface PlaygroundMutatorKind {
  boolSparse?: PlaygroundMutatorKindBoolSparse;
  boolValue?: PlaygroundMutatorKindBoolValue;
  floatSparse?: PlaygroundMutatorKindFloatSparse;
  floatValue?: PlaygroundMutatorKindFloatValue;
  intSparse?: PlaygroundMutatorKindIntSparse;
  intValue?: PlaygroundMutatorKindIntValue;
  stringValue?: PlaygroundMutatorKindStringValue;
}
