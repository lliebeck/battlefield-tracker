 ...
 */
import type { FrostbiteWeaponStatsAvatar } from './frostbiteWeaponStatsAvatar';
import type { FrostbiteWeaponStatsUserId } from './frostbiteWeaponStatsUserId';
import type { FrostbiteWeaponStatsUserName } from './frostbiteWeaponStatsUserName';
import type { FrostbiteWeaponInfo } from './frostbiteWeaponInfo';

export interface FrostbiteWeaponStats {
  avatar?: FrostbiteWeaponStatsAvatar;
  id: number;
  userId?: FrostbiteWeaponStatsUserId;
  userName?: FrostbiteWeaponStatsUserName;
