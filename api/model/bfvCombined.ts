...
import type { BfvCombinedAvatar } from './bfvCombinedAvatar';
import type { FrostbiteClassInfo } from './frostbiteClassInfo';
import type { BfvCombinedUserId } from './bfvCombinedUserId';
import type { BfvCombinedUserName } from './bfvCombinedUserName';
import type { FrostbiteVehicleInfo } from './frostbiteVehicleInfo';
import type { FrostbiteWeaponInfo } from './frostbiteWeaponInfo';

export interface BfvCombined {
  accuracy: number;
  activePlatoon: FrostbitePlatoonInfo;
  avatar?: BfvCombinedAvatar;
  avengerKills: number;
  awardScore: number;
  bestClass: number;
  bonusScore: number;
  ...
  userId?: BfvCombinedUserId;
  userName?: BfvCombinedUserName;
