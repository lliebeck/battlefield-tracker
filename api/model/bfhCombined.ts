 ...
 */
import type { BfhCombinedAvatar } from './bfhCombinedAvatar';
import type { BfhClassInfo } from './bfhClassInfo';
import type { BattlelogPlatoonInfo } from './battlelogPlatoonInfo';
import type { ProgressInfo } from './progressInfo';
import type { BfhCombinedUserId } from './bfhCombinedUserId';
import type { BfhCombinedUserName } from './bfhCombinedUserName';
import type { BattlelogVehicleStats } from './battlelogVehicleStats';
import type { BattlelogWeaponStats } from './battlelogWeaponStats';

export interface BfhCombined {
  accuracy: number;
  avatar?: BfhCombinedAvatar;
  avengerKills: number;
  bestClass: number;
  cashPerMinute: number;
  classes: BfhClassInfo[];
  deaths: number;
  enforcer: number;
  hacker: number;
  headShots: number;
  ...
  timePlayed: string;
  userId?: BfhCombinedUserId;
  userName?: BfhCombinedUserName;
