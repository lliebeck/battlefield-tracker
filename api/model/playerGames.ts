 ...
 */
import type { PlayerGamesAvatar } from './playerGamesAvatar';
import type { PlayerGamesUserId } from './playerGamesUserId';
import type { PlayerGamesUserName } from './playerGamesUserName';

export interface PlayerGames {
  avatar?: PlayerGamesAvatar;
  bf1: boolean;
  bf2042: boolean;
  bf3: boolean;
  bf4: boolean;
  ...
  bfv: boolean;
  id: number;
  userId?: PlayerGamesUserId;
  userName?: PlayerGamesUserName;
}
