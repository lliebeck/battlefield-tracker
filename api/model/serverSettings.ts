 ...
 */
import type { ServerSettingsKits } from './serverSettingsKits';
import type { ServerSettingsMisc } from './serverSettingsMisc';
import type { ServerSettingsScales } from './serverSettingsScales';
import type { ServerSettingsVehicles } from './serverSettingsVehicles';
import type { ServerSettingsWeapons } from './serverSettingsWeapons';

export interface ServerSettings {
  Kits: ServerSettingsKits;
  Misc: ServerSettingsMisc;
  Scales: ServerSettingsScales;
  Vehicles: ServerSettingsVehicles;
  Weapons: ServerSettingsWeapons;
}
