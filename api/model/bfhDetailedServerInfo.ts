 ...
 */
import type { Bf4PlayerList } from './bf4PlayerList';
import type { ServerRotation } from './serverRotation';
import type { Bf3ServerSettings } from './bf3ServerSettings';
import type { Bf4Team } from './bf4Team';

export interface BfhDetailedServerInfo {
  currentMap: string;
  ...
  playerAmount: number;
  players: Bf4PlayerList[];
  prefix: string;
  region: string;
  rotation: ServerRotation[];
  serverLink: string;
  settings: Bf3ServerSettings;
  smallmode: string;
  teams: Bf4Team[];
}
