 ...
 */
import type { ManagerServerInfo } from './managerServerInfo';
import type { ManagerServerTeam } from './managerServerTeam';

export interface ManagerServerPlayers {
  info: ManagerServerInfo;
  players: ManagerServerTeam[];
  serverId: string;
}
