 ...
 */
import type { FrostbiteServerPlayer } from './frostbiteServerPlayer';
import type { ServerInfo } from './serverInfo';
import type { FrostbiteServerTeam } from './frostbiteServerTeam';

export interface Bf1ServerPlayers {
  loading: FrostbiteServerPlayer[];
  que: FrostbiteServerPlayer[];
  serverinfo: ServerInfo;
  teams: FrostbiteServerTeam[];
