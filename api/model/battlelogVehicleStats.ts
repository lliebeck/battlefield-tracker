 ...
 */
import type { BattlelogVehicleStatsAvatar } from './battlelogVehicleStatsAvatar';
import type { BattlelogVehicleStatsUserId } from './battlelogVehicleStatsUserId';
import type { BattlelogVehicleStatsUserName } from './battlelogVehicleStatsUserName';
import type { BattlelogVehicleInfo } from './battlelogVehicleInfo';

export interface BattlelogVehicleStats {
  avatar?: BattlelogVehicleStatsAvatar;
  id: number;
  userId?: BattlelogVehicleStatsUserId;
  userName?: BattlelogVehicleStatsUserName;
  vehicles: BattlelogVehicleInfo[];
}
