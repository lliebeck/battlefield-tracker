...
export type LoggedServerDataBfvServerarrayGetParams = {
/**
 * Number of days to get historic values for
 */
days?: number;
/**
 * Id of the server to get historic values for
 */
gameid?: string | null;
/**
 * A more permanent id of the server to get historic values for
 */
serverid?: string | null;
/**
 * Name of the server to get historic values for
 */
