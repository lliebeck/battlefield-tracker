 ...
 */
import type { ManagerServerPlayer } from './managerServerPlayer';
import type { ManagerLivePlayerInfo } from './managerLivePlayerInfo';
import type { ManagerLivePlayerServer } from './managerLivePlayerServer';
import type { ManagerLivePlayerStats } from './managerLivePlayerStats';

export interface ManagerLivePlayer {
  ingamePlayerInfo: ManagerServerPlayer;
  playerInfo: ManagerLivePlayerInfo;
  server: ManagerLivePlayerServer;
  stats: ManagerLivePlayerStats;
}
