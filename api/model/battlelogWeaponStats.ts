 ...
 */
import type { BattlelogWeaponStatsAvatar } from './battlelogWeaponStatsAvatar';
import type { BattlelogWeaponStatsUserId } from './battlelogWeaponStatsUserId';
import type { BattlelogWeaponStatsUserName } from './battlelogWeaponStatsUserName';
import type { BattlelogWeaponInfo } from './battlelogWeaponInfo';

export interface BattlelogWeaponStats {
  avatar?: BattlelogWeaponStatsAvatar;
  id: number;
  userId?: BattlelogWeaponStatsUserId;
  userName?: BattlelogWeaponStatsUserName;
  weapons: BattlelogWeaponInfo[];
}
