...
export type FrostbiteRegionsWithMultiple = typeof FrostbiteRegionsWithMultiple[keyof typeof FrostbiteRegionsWithMultiple];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const FrostbiteRegionsWithMultiple = {
  all: 'all',
  eu: 'eu',
  asia: 'asia',
  nam: 'nam',
