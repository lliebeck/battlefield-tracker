 ...
 */
import type { ManagerPlayerGamemode } from './managerPlayerGamemode';
import type { ManagerPlayerKit } from './managerPlayerKit';

export interface ManagerPlayerLeaderBoard {
  deaths: number;
  gamemodes: ManagerPlayerGamemode[];
  killDeath: number;
  kills: number;
  kits: ManagerPlayerKit[];
  losses: number;
  name: string;
  platoon: string;
  playerId: number;
