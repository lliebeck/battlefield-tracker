 ...
 */
import type { ServerOwner } from './serverOwner';
import type { PlatoonResult } from './platoonResult';
import type { ServerRotation } from './serverRotation';
import type { ServerSettings } from './serverSettings';
import type { ServerTeams } from './serverTeams';

export interface Bf1DetailedServerInfo {
  country: string;
  currentMap: string;
