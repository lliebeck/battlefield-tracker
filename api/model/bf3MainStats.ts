 ...
 */
import type { Bf3MainStatsAvatar } from './bf3MainStatsAvatar';
import type { Bf3MainStatsUserId } from './bf3MainStatsUserId';
import type { Bf3MainStatsUserName } from './bf3MainStatsUserName';

export interface Bf3MainStats {
  accuracy: number;
  avatar?: Bf3MainStatsAvatar;
  avengerKills: number;
  bestClass: number;
  ...
  userId?: Bf3MainStatsUserId;
  userName?: Bf3MainStatsUserName;
  winPercent: number;
  wins: number;
}
