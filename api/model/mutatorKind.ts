 ...
 */
import type { MutatorKindBoolSparse } from './mutatorKindBoolSparse';
import type { MutatorKindBoolValue } from './mutatorKindBoolValue';
import type { MutatorKindFloatSparse } from './mutatorKindFloatSparse';
import type { MutatorKindFloatValue } from './mutatorKindFloatValue';
import type { MutatorKindIntSparse } from './mutatorKindIntSparse';
import type { MutatorKindIntValue } from './mutatorKindIntValue';
import type { MutatorKindStringValue } from './mutatorKindStringValue';

export interface MutatorKind {
  boolSparse?: MutatorKindBoolSparse;
  boolValue?: MutatorKindBoolValue;
  floatSparse?: MutatorKindFloatSparse;
  floatValue?: MutatorKindFloatValue;
  intSparse?: MutatorKindIntSparse;
  intValue?: MutatorKindIntValue;
  stringValue?: MutatorKindStringValue;
}
