 ...
 */
import type { BfhMainStatsAvatar } from './bfhMainStatsAvatar';
import type { BfhMainStatsUserId } from './bfhMainStatsUserId';
import type { BfhMainStatsUserName } from './bfhMainStatsUserName';

export interface BfhMainStats {
  accuracy: number;
  avatar?: BfhMainStatsAvatar;
  avengerKills: number;
  bestClass: number;
  ...
  timePlayed: string;
  userId?: BfhMainStatsUserId;
  userName?: BfhMainStatsUserName;
  winPercent: number;
  wins: number;
}
