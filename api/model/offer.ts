 ...
 */
import type { OfferIdOrigin } from './offerIdOrigin';
import type { OfferIdPlayStation } from './offerIdPlayStation';
import type { OfferIdXbox } from './offerIdXbox';

export interface Offer {
  crossPlatformId: string;
  pc: OfferIdOrigin;
  ps: OfferIdPlayStation;
  xbox: OfferIdXbox;
}
