 ...
 */
import type { GamemodeStatsAvatar } from './gamemodeStatsAvatar';
import type { FrostbiteGamemodeInfo } from './frostbiteGamemodeInfo';
import type { GamemodeStatsUserId } from './gamemodeStatsUserId';
import type { GamemodeStatsUserName } from './gamemodeStatsUserName';

export interface GamemodeStats {
  avatar?: GamemodeStatsAvatar;
  gamemodes: FrostbiteGamemodeInfo[];
  id: number;
  userId?: GamemodeStatsUserId;
  userName?: GamemodeStatsUserName;
}
